...
void DataMerger()
{
    ...
    TH2F *NewEnergyTrigTimeX = new TH2F("NewEnergyTrigTimeX","Energy and Time of Trigger X axis stopping proton+Crosstalk", 100,-100,100,500,0,1500);
    TH2F *NewEnergyTrigTimeY = new TH2F("NewEnergyTrigTimeY","Energy and Time of Trigger Y axis stopping proton+Crosstalk", 100,-100,100,500,0,1500);
